...
const en = {
  ...
  handlerMissing: "The subscription handler was not found. Check its Handler property and the common module source.",
...
const ru: Record<keyof typeof en, string> = {
  ...
  handlerMissing: "Обработчик подписки не найден. Проверьте свойство «Обработчик» и исходник общего модуля.",
